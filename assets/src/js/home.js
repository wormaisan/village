...
/* harmony import */ var _common__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./common */ "./assets/src/js/common.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.gallery__sliderBody--territory').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1,
  "infinite": false,
  "appendArrows": jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slider__btns--territory')
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.gallery__sliderBody--transport').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1,
  "infinite": false,
  "appendArrows": jquery__WEBPACK_IMPORTED_MODULE_0___default()('.slider__btns--transport')
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.variants__slider--1 .variants__sliderBody').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1,
  "infinite": false,
  "appendArrows": jquery__WEBPACK_IMPORTED_MODULE_0___default()('.variants__slider--1 .slider__btns')
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.variants__slider--2 .variants__sliderBody').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1,
  "infinite": false,
  "appendArrows": jquery__WEBPACK_IMPORTED_MODULE_0___default()('.variants__slider--2 .slider__btns')
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.variants__slider--3 .variants__sliderBody').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1,
  "infinite": false,
  "appendArrows": jquery__WEBPACK_IMPORTED_MODULE_0___default()('.variants__slider--3 .slider__btns')
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.select__slider--1 .select__sliderItems').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.select__slider--2 .select__sliderItems').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.select__slider--3 .select__sliderItems').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.select__slider--4 .select__sliderItems').slick({
  "slidesToShow": 1,
  "slidesToScroll": 1
});
var fieldsPhone = document.querySelectorAll('.sendForm__phone');
window.onload = function () {
  ...
  for (var i = 0; i <= fieldsPhone.length - 1; i++) {
...
// масштабирование фона при нажатии на плюс/минус
var planImg = document.querySelector('.plan__img img');
var btnPlus = document.querySelector('.plan__btnPlus');
var btnMinus = document.querySelector('.plan__btnMinus');
var planMarkers = document.querySelectorAll('.plan__info');
var oldBgcSize = 1;
var newBgcSize = 1;
var markerLeft = 0;
var markerTop = 0;
var markerOffsetLeft = 0;
var markerOffsetTop = 0;
planImg.style.transform = 'scale(1)';
function changePosMarkers(operation) {
  if (planMarkers.length > 0) {
    for (var _i = 0; _i < planMarkers.length; _i++) {
      markerLeft = getComputedStyle(planMarkers[_i]).getPropertyValue('left');
      markerLeft = Number(markerLeft.substring(0, markerLeft.length - 2));
      markerTop = getComputedStyle(planMarkers[_i]).getPropertyValue('top');
      markerTop = Number(markerTop.substring(0, markerTop.length - 2));
      markerOffsetLeft = Number(planMarkers[_i].dataset.offsetX);
      markerOffsetTop = Number(planMarkers[_i].dataset.offsetY);
      if (operation === 'plus') {
        markerLeft = markerLeft + markerOffsetLeft + 'px';
        markerTop = markerTop + markerOffsetTop + 'px';
      }
      if (operation === 'minus') {
        markerLeft = markerLeft - markerOffsetLeft + 'px';
        markerTop = markerTop - markerOffsetTop + 'px';
      }
      planMarkers[_i].style.setProperty('left', markerLeft);
      planMarkers[_i].style.setProperty('top', markerTop);
    }
  }
}
function changeScale(operation) {
  oldBgcSize = newBgcSize;
  if (operation === 'plus') {
    newBgcSize += 0.2;
    changePosMarkers('plus');
  }
  if (operation === 'minus') {
    newBgcSize -= 0.2;
    changePosMarkers('minus');
  }
  if (newBgcSize === oldBgcSize) {
    console.log('ошибка изменения масштаба ');
  } else {
    planImg.style.transform = 'scale(' + newBgcSize + ')';
  }
  if (newBgcSize === 1) {
    btnMinus.classList.add('deactivate');
  }
}
btnPlus.addEventListener('click', function () {
  btnMinus.classList.remove('deactivate');
  changeScale('plus');
});
btnMinus.addEventListener('click', function () {
  if (this.classList.contains('deactivate') === false) {
    changeScale('minus');
  }
});
